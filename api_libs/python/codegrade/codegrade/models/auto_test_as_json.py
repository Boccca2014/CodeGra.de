...
class AutoTestAsJSON:
    ...
    @staticmethod
    def from_dict(d: Dict[str, Any]) -> AutoTestAsJSON:
        base = {}
        id = d["id"]
        ...
        for runs_item_data in d["runs"]:
            runs_item = AutoTestRunAsJSON.from_dict(cast(Dict[str, Any], runs_item_data))
